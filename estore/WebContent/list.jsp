...
<title>briup电子商务-显示该种类下的书籍信息</title>
                     ...
                     <c:forEach	var="book" items="${sessionScope.books }">
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="BookViewByBookId?bookId=${book. bookId}"><img src="images/list_p1.png"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${book.price }</h1>
                            <h2><a href="BookViewByBookId?bookId=${book. bookId}">${book.name }</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
