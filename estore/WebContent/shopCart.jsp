	...
	<div class="mainCenter">
		...
		<div class="mainPro">
			<div class="aa">
			   ...
			   <c:forEach items="${sessionScope.sCar.lines }" var="entry">
			   <form>
                <table>
                    <tbody>
                        <tr>
                            <td class="index">${entry.key }</td>
                            <td>
                            ...
                            <td>
                                <span>${entry.value.book.price*entry.value.num }</span>
                            </td>
                            <td>
                                <button>保存</button>
                                <button>取消</button>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <a href="ConfirmServlet" class="caozuo">去提交</a>
                    <span>已选择<font>${sessionScope.sCar.num }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>${sessionScope.sCar.cost}元</font></span>
                </div>
